...
try:
    df = pd.read_csv("generalizability_final_behavioral_metrics_all_simulated.csv")
...
plt.suptitle('Behavioral metrics across datasets (Eckstein 2022)', fontsize=12, fontweight='bold', y=0.98)

save_path = os.path.join(output_dir, '500eck_behavioral_metrics_across_datasets.png')
