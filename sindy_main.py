...
params_path = parameter_file_naming('params/params', use_lstm, last_output, last_state, beta, forget_rate, perseveration_bias, correlated_update, False, non_binary_reward, verbose=True)
