...
def parameter_file_naming(params_path, use_lstm, gen_alpha, gen_beta, forget_rate, perseverance_bias, correlated_reward, non_fixed_lr, momentum, non_binary_reward, verbose=False):
