...
def main(
    iterations = 1,
    n_sessions = [4096, 1024, 256, 64, 16, 4, 1]
    epochs = 1,
    ):
    
    if not os.path.exists('datasize_analysis'):
        os.makedirs('datasize_analysis')
    if not os.path.exists('datasize_analysis/plots'):
        os.makedirs('datasize_analysis/plots')
